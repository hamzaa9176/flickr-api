  ...
  return (
    <div className="fixed top-0 left-0 w-full h-screen bg-gray-800 mx-auto ">
      <button
        ...
        className="bg-white rounded-md p-2 absolute right-5 top-5 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500"
      >
      ...
      <img
        className="block m-auto object-cover object-center h-screen w-auto"
        src={src}
        alt="sd"
      />
    </div>
